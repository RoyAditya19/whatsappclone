...
function IncomingVideoCall() {
  ...
  return <div className=" h-24 w-80 fixed bottom-8 mb-0 right-6 rounded-sm flex gap-5 justify-start p-4 bg-conversation-panel-background text-white z-50 items-center drop-shadow-2xl border-icon-green border-2 py-14">
     <div>
          <Image
