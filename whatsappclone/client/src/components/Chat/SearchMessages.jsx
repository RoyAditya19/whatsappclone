    ...
    <div className=" border-conversation-border border-l w-full bg-conversation-panel-background flex flex-col z-10 max-h-screen">
      ...
      <div className=" overflow-auto custom-scrollbar h-full">
        ...
        <div className=" flex justify-center h-full flex-col ">
          ...
          {
               searchedMessages.map((message)=> (<div className=" flex cursor-pointer flex-col justify-center hover:bg-background-default-hover w-full px-5 border-b-[0.1px] border-secondary">
